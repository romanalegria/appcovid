...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="{{ asset('images/logomuni.png') }}"> <span class="navbar-brand-name">LautaroCovid</span></a>
            </div>
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        <a href="{{ url('rentas') }}" >
                         ...
                         <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#topAccordion">
                            <li>
                                <a href="{{url('pacientes')}}"> FICHA PACIENTE </a>
                            </li>
                            <li>
                                <a href="{{url('contactos')}}"> FICHA CONTACTO </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        <a href="{{ url('tarifas') }}" >
                            ...
                            <ul class="collapse submenu list-unstyled" id="components" data-parent="#topAccordion">
                            <li>
                                <a href="{{ url('casos') }}">NUEVO CASO </a>
                            </li>
                            <li>
                                <a href="{{ url('comunas') }}"> CONSULTAR CASO  </a>
                            </li>
                             <li>
                                <a href="{{ url('ciudades') }}"> CERRAR CASO  </a>
                            </li>
                        </ul>
    ...
    @if($comuna <= 0)
      <script type="text/javascript">
          toastr.warning("POR FAVOR CONFIGURE DATOS DE COMUNAS")
      </script>
    @endif
